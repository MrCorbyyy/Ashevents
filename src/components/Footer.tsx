        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <p className="text-[0.9rem] font-medium">asheventsgh_</p>
            </a>
            <div className="flex items-center gap-4 text-slate-500 hover:text-blue-600 transition-colors group cursor-default">
              ...
              <p className="text-[0.9rem] font-medium">@asheventsgh(TikTok)</p>
            </div>
            <div className="flex items-center gap-4 text-slate-500 hover:text-blue-600 transition-colors group cursor-default">
              ...
              <p className="text-[0.9rem] font-medium">blacashaaa (Snapchat)</p>
            </div>
          </div>
        </div>
      </div>
